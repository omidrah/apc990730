...
namespace ActiveProbe.DataLayer.Migrations
{
    ...
    [Migration("20201019161234_990228-notificationAndRemoveSqlCache")]
    partial class _990228notificationAndRemoveSqlCache
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActiveProbe.Domain.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<TimeSpan>("SendEndTime")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("SendStartTime")
                        .HasColumnType("time");

                    b.Property<int>("TimeIntervalToNextSend")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ActiveProbe.Domain.Models.NotificationFilter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ConditionalValueTypeId")
                        .HasColumnType("int");

                    b.Property<string>("FilterlogicalSymbol")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("LogicalSymbolTypeId")
                        .HasColumnType("int");

                    b.Property<int>("NotificationParameterId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("NotificationParameterId");

                    b.ToTable("NotificationFilter");
                });

            modelBuilder.Entity("ActiveProbe.Domain.Models.NotificationParameter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("NotificationParameter");
                });
            ...
            modelBuilder.Entity("ActiveProbe.Domain.Models.SendedNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ActiveProbe.Domain.Models.NotificationFilter", b =>
                {
                    b.HasOne("ActiveProbe.Domain.Models.NotificationParameter", "NotificationParameter")
                        .WithMany("NotificationFilters")
                        .HasForeignKey("NotificationParameterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ActiveProbe.Domain.Models.NotificationParameter", b =>
                {
                    b.HasOne("ActiveProbe.Domain.Models.Notification", "Notification")
                        .WithMany("NotificationParameters")
