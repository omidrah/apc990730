...
{
    public interface IApcSignInManager
    {
        #region BaseClass
        ...
        /// <summary>
        /// Returns true if the principal has an identity with the Apc cookie identity
        /// </summary>
        ...
        /// <summary>
        /// Regenerates the user's Apc cookie, whilst preserving the existing
        ...
        /// <summary>
        /// Signs the current user out of the Apc.
        /// </summary>
        Task SignOutAsync();
        ...
        /// <summary>
        /// Returns true if the current user has an identity with the Apc cookie identity
        /// </summary>
