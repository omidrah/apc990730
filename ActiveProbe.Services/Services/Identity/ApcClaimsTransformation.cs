...
namespace ActiveProbe.Services
{
    ...
    public class ApcClaimsTransformation : IClaimsTransformation
    {
        private readonly IApcUserManager _userManager;
        private readonly IApcRoleManager _roleManager;
        private readonly ILogger<ApcClaimsTransformation> _logger;

        public ApcClaimsTransformation(
            IApcUserManager userManager,
            IApcRoleManager roleManager,
            ILogger<ApcClaimsTransformation> logger)
        {
