...
namespace ActiveProbe.Services
{
        ...
        IApcRoleManager
    {
        ...
        private readonly ILogger<ApcRoleManager> _logger;
        private readonly IEnumerable<IRoleValidator<Role>> _roleValidators;
        private readonly IApcRoleStore _store;
        private readonly DbSet<User> _users;

        public ApcRoleManager(
            IApcRoleStore store,
            IEnumerable<IRoleValidator<Role>> roleValidators,
            IdentityErrorDescriber errors,
            ILookupNormalizer keyNormalizer,
            ILogger<ApcRoleManager> logger,
            IHttpContextAccessor contextAccessor,
            IUnitOfWork uow) :
            base((RoleStore<Role, ActiveProbeCoreContext, int, UserRole, RoleClaim>)store, roleValidators, keyNormalizer, errors, logger)
        {
