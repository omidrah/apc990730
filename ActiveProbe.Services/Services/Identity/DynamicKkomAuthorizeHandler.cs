...
{
    public class KkomAuthorize : IAuthorizationRequirement
    {
    }

    public class KkomAuthorizationHandler : AuthorizationHandler<KkomAuthorize>
    {
        private readonly ISecurityTrimmingService _securityTrimmingService;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public KkomAuthorizationHandler(
