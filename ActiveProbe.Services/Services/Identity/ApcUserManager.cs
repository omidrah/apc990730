...
namespace ActiveProbe.Services
{
        ...
        IApcUserManager
    {
        ...
        private readonly ILogger<ApcUserManager> _logger;
        ...
        public ApcUserManager(
            ...
            ILogger<ApcUserManager> logger,
            IHttpContextAccessor contextAccessor,
            IUnitOfWork uow)
            : base(
                (UserStore<User, Role, ActiveProbeCoreContext, int, UserClaim, UserRole, UserLogin, UserToken, RoleClaim>)store,
        ...
        string IApcUserManager.CreateTwoFactorRecoveryCode()
        {
            return base.CreateTwoFactorRecoveryCode();
        }

        Task<PasswordVerificationResult> IApcUserManager.VerifyPasswordAsync(IUserPasswordStore<User> store, User user, string password)
        {
        ...
        IPasswordHasher<User> IApcUserManager.PasswordHasher { get => base.PasswordHasher; set => base.PasswordHasher = value; }

        IList<IUserValidator<User>> IApcUserManager.UserValidators => base.UserValidators;

        IList<IPasswordValidator<User>> IApcUserManager.PasswordValidators => base.PasswordValidators;

        IQueryable<User> IApcUserManager.Users => base.Users;
        ...
        Task<IdentityResult> IApcUserManager.UpdatePasswordHash(User user, string newPassword, bool validatePassword)
        {
