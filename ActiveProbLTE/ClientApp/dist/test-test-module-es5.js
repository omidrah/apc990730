...
var DefinedTestComponent = /** @class */ (function () {
    function DefinedTestComponent(_http, toastrService, translate) {
        this._http = _http;
    ...
    DefinedTestComponent.prototype.getDefinedTests = function () {
        var _this = this;
        this.showloader = true;
        this._http.get('api/DefinedTest/Index').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
            return response;
    ...
    DefinedTestComponent.prototype.applyFilter = function (event) {
    ...
    DefinedTestComponent.prototype.deleteTest = function (id, title) {
        this.selectedId = id;
        this.title = title;
    };
    DefinedTestComponent.prototype.doDelete = function () {
        var _this = this;
        this.showloader = true;
        this._http.delete('api/DefinedTest/Delete/' + this.selectedId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
            _this.showloader = false;
            if (response == 2) {
                _this.toastrService.error(_this.translate.instant('CannotDeleteAssignedTest'), _this.translate.instant('Error'));
            }
            return response;
        })).subscribe(function () {
            _this.getDefinedTests();
            $('#modal-default').modal('hide');
        }, function (error) { return console.error(error); });
    };
    DefinedTestComponent.ctorParameters = function () { return [
...
var DefinedTestEditComponent = /** @class */ (function () {
    ...
    DefinedTestEditComponent.ctorParameters = function () { return [
...
/* harmony import */ var _angular_material_sort__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/material/sort */ "./node_modules/@angular/material/esm5/sort.es5.js");
...
var DefinedTestGroupAssignmentComponent = /** @class */ (function () {
    function DefinedTestGroupAssignmentComponent(_http, _avRoute, langService, baseUrl) {
        this._http = _http;
        this._avRoute = _avRoute;
    ...
    DefinedTestGroupAssignmentComponent.prototype.getDefinedTests = function (id) {
        var _this = this;
        this._http.get(this.myAppUrl + 'api/MachineGroup/IndexWithDefinedTest/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) {
            return response;
        })).subscribe(function (data) {
            _this.definedTestMachineGroupList = data;
            _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](data);
            _this.dataSource.paginator = _this.paginator;
            _this.dataSource.sort = _this.sort;
        });
    };
    DefinedTestGroupAssignmentComponent.prototype.applyFilter = function (event) {
        var filterValue = event.target.value;
        this.dataSource.filter = filterValue.trim().toLowerCase();
        if (this.dataSource.paginator) {
            this.dataSource.paginator.firstPage();
    ...
    DefinedTestGroupAssignmentComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    ...
    return DefinedTestGroupAssignmentComponent;
}());
...
var DefinedTestGroupAssignmentEditComponent = /** @class */ (function () {
    ...
    DefinedTestGroupAssignmentEditComponent.prototype.save = function () {
        var _this = this;
    ...
    DefinedTestGroupAssignmentEditComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var DefinedTestMachineAssignmentComponent = /** @class */ (function () {
    function DefinedTestMachineAssignmentComponent(_http, _avRoute, langService, baseUrl) {
        this._http = _http;
        this._avRoute = _avRoute;
        this.langService = langService;
        this.displayedColumns = ['index', 'definedTestTitle', 'testTypeTitle', 'beginDate', 'endDate', 'status', 'actions'];
    ...
    DefinedTestMachineAssignmentComponent.prototype.getDefinedTests = function (id) {
        var _this = this;
        this._http.get(this.myAppUrl + 'api/Machine/IndexWithDefinedTest/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) {
            response.forEach(function (element) {
                ...
                if (element["status"] == true && bdDate > _this.currentDate) {
                    element["status"] = Waiting;
                }
                if (element["status"] == true && bdDate == _this.currentDate) {
                    if (bdTime > _this.currentTime) {
                        element["status"] = Waiting;
                    }
                }
                if (element["status"] == true) {
                    if (bdDate < _this.currentDate) {
                        if (_this.currentDate < edDate) {
                            element["status"] = Running;
                        }
                    }
                    else if (bdDate == _this.currentDate) {
                        if (bdTime < _this.currentTime) {
                            if (_this.currentDate < edDate) {
                                element["status"] = Running;
                            }
                            else if (_this.currentDate == edDate) {
                                if (_this.currentTime < edTime) {
                                    element["status"] = Running;
                                }
                            }
                        }
                ...
                if (element["status"] == true && (_this.currentDate > edDate)) {
    ...
    DefinedTestMachineAssignmentComponent.prototype.applyFilter = function (event) {
        var filterValue = event.target.value;
        this.dataSource.filter = filterValue.trim().toLowerCase();
        if (this.dataSource.paginator) {
            this.dataSource.paginator.firstPage();
    ...
    DefinedTestMachineAssignmentComponent.prototype.ngOnInit = function () { };
    DefinedTestMachineAssignmentComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    ...
    return DefinedTestMachineAssignmentComponent;
}());
...
var DefinedTestMachineAssignmentEditComponent = /** @class */ (function () {
    ...
    DefinedTestMachineAssignmentEditComponent.prototype.save = function () {
        var _this = this;
    ...
    DefinedTestMachineAssignmentEditComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
