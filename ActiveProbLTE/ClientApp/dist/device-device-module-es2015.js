...
/* harmony import */ var _angular_material_tree__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/material/tree */ "./node_modules/@angular/material/esm2015/tree.js");
...
let GroupVersionComponent = class GroupVersionComponent {
    constructor(_avRoute, router, _http, toast, translate) {
    ...
    getVersionList() {
        ...
        this.vlSubscription.add(this._http.get('api/Version/Group/' + this.selectedGroupid).subscribe((data) => {
            this.showloader = false;
            if (data != null) {
                this.versions = data;
    ...
    checkCanUpdate() {
        this.vlSubscription.add(this._http.post('api/Version/canUpdate/', this.selectedGroupid).subscribe((data) => {
            if (data["code"] = 5) {
...
GroupVersionComponent.ctorParameters = () => [
...
let MachineVersionComponent = class MachineVersionComponent {
    constructor(_http, _avRoute, router, toast, translate) {
        this._http = _http;
        this._avRoute = _avRoute;
        this.router = router;
        this.toast = toast;
    ...
    getVersionList() {
        this.allSubscribtion.add(this._http.get('api/Version/Index/' + this.MachineId).subscribe((data) => {
            if (data != null) {
                this.versions = data;
...
MachineVersionComponent.ctorParameters = () => [
...
let MachineComponent = class MachineComponent {
    constructor(_http, toastrService, translate, langService, _config) {
        this._http = _http;
    ...
    getMachines() {
        ...
        this._http.get('api/Machine/Index').subscribe((data) => {
            ...
            this.modemDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](data);
    ...
    doDelete() {
        this.showloader = true;
        this._http.delete('api/machine/Delete/' + this.selectedId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(response => {
            this.showloader = false;
            if (response == 2) {
...
MachineComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
...
let ChecklistDatabase = class ChecklistDatabase {
    ...
    initialize() {
        this._http.get('api/MachineGroup/Index').subscribe((data) => {
            //data.forEach(val => {
            ...
            var treeData = sortData.reduce((accumulator, key) => {
    ...
    searchTree(elements, matchingId) {
        var findItem = null;
    ...
    setNodeChecked(elements, nodeId) {
        var node = this.searchTree(elements, nodeId);
        node.checked = true;
        this.dataChange.next(this.data);
    }
    checkAllNode(elements, check) {
        for (let nodeItem of elements) {
...
let DownlineTreeviewEventParser = class DownlineTreeviewEventParser extends ngx_treeview__WEBPACK_IMPORTED_MODULE_6__["TreeviewEventParser"] {
    whoIsChecked(item) {
...
let OrderDownlineTreeviewEventParser = class OrderDownlineTreeviewEventParser extends ngx_treeview__WEBPACK_IMPORTED_MODULE_6__["TreeviewEventParser"] {
    constructor() {
        super(...arguments);
...
let MachineEditComponent = class MachineEditComponent {
    constructor(_http, _database, _fb, _avRoute, _router, baseUrl, _config) {
        this._http = _http;
        ...
        this.getMachineGroupList().subscribe((data) => this.machineGroupList = data);
        if (this._avRoute.snapshot.params['id']) {
    ...
    ngOnInit() {
        ...
        this.getMachineTypeList().subscribe((data) => this.machineTypeList = data);
    }
    checkAllNode(check) {
...
MachineEditComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
...
let ChecklistDatabase = class ChecklistDatabase {
    ...
    insertItem(parent, name) {
        const child = { item: name, editing: false };
...
let MachineGroupComponent = class MachineGroupComponent {
    constructor(_database, router, toastrService, translate, _config) {
        this._database = _database;
        this.router = router;
        this.toastrService = toastrService;
        this.translate = translate;
...
let MachineGroupEditComponent = class MachineGroupEditComponent {
    ...
    getMachines(id) {
        ...
        this._http.get(this.myAppUrl + 'api/Machine/IndexWithMachineGroup/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(response => {
            return response;
        })).subscribe((data) => {
    ...
    updateMachineGroupNia(machingeGroupId, list) {
...
MachineGroupEditComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
let MatTableTestComponent = class MatTableTestComponent {
    constructor(_http, router, toastrService) {
        this._http = _http;
        this.router = router;
        this.toastrService = toastrService;
        this.displayedColumns = ['index', 'name', 'identifier', 'machineTypeTitle', 'machineGroupTitle', 'Location', 'imeI1', 'imeI2', 'version', 'status', 'testStatus', 'actions'];
    ...
    delete(id) {
        ...
        if (ans) {
            this._http.delete('api/machine/Delete/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(response => {
                if (response == 2) {
...
MatTableTestComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
...
let MessageEditComponent = class MessageEditComponent {
    constructor(_http, _avRoute, _fb, _router, toastrService, translate) {
        this._http = _http;
        this._avRoute = _avRoute;
        this._fb = _fb;
        this._router = _router;
...
let MessageComponent = class MessageComponent {
    constructor(_http, _avRoute, toastrService, langService, translate, _decoder) {
        this._http = _http;
        this._avRoute = _avRoute;
        this.toastrService = toastrService;
        this.langService = langService;
 ...
 */
let TreeMediumTestComponent = class TreeMediumTestComponent {
...
TreeMediumTestComponent.ctorParameters = () => [
...
let ChecklistDatabase = class ChecklistDatabase {
    ...
    addRootNode() {
        const child = { item: '', editing: false };
 ...
 * @title Tree with checkboxes
 */
let TreeTestAddComponent = class TreeTestAddComponent {
    constructor(_database, router) {
        this._database = _database;
        this.router = router;
        /** Map from flat node to nested node. This helps us finding the nested node to be modified */
        this.flatNodeMap = new Map();
...
TreeTestAddComponent.ctorParameters = () => [
    { type: ChecklistDatabase },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"] }
];
