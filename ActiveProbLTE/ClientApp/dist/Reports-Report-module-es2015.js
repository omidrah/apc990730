...
let ExportComponent = class ExportComponent {
    constructor(_http, _fb, _avRoute, _router, baseUrl, calendar, toastrService, translate, _config) {
        this._http = _http;
        this._fb = _fb;
        ...
        this.getMachineList().subscribe((data) => {
            this.machineList = data;
            this.selectedFirstMachine = +this.machineList[0].id;
            //console.log(this.machineList)
        });
        this.getZones().subscribe((data) => {
            this.zoneList = data;
...
let NotificationEditComponent = class NotificationEditComponent {
    constructor(_http, _avRoute, _fb, _router, toastrService, translate) {
        ...
        this.notificationForm = this._fb.group({
            ...
            maxSend: [, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].min(0)]],
            timeIntervalToNextSend: [, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].min(0)]],
...
NotificationEditComponent.ctorParameters = () => [
...
let NotificationManagerComponent = class NotificationManagerComponent {
...
NotificationManagerComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
...
//# sourceMappingURL=Reports-Report-module-es2015.js.map