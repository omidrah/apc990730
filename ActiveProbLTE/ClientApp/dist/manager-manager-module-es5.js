...
var ManagerService = /** @class */ (function () {
    ...
    ManagerService.prototype.getRole = function () {
        return this._http.get('api/RoleManager/Index').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (_) { return console.log("list of roles"); }));
    };
...
var RoleAccessComponent = /** @class */ (function () {
    ...
    RoleAccessComponent.prototype.DynamicCtrl = function () {
        var _this = this;
        this._manager.getAccess(this.selectedRoleId).pipe(Object(rxjs_internal_operators_map__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
    ...
    RoleAccessComponent.prototype.submit = function () {
        ...
        this._manager.updateRoleAccess(+this.selectedRoleId, dd).subscribe(function (data) {
    ...
    RoleAccessComponent.prototype.addCheckboxes = function () {
        ...
        this.controllers.forEach(function (item, ind) {
            _this.actsFormArray.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]({ 'disp': item["disp"], 'controllerId': item["controllerId"], 'actions': item["actions"] }));
        });
    };
...
var RoleManagerComponent = /** @class */ (function () {
    ...
    RoleManagerComponent.ctorParameters = function () { return [
...
var UserChangePassComponent = /** @class */ (function () {
    ...
    UserChangePassComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _Shared_services_manager_service__WEBPACK_IMPORTED_MODULE_3__["ManagerService"] }
...
var UserManagerComponent = /** @class */ (function () {
    ...
    UserManagerComponent.prototype.getUsers = function () {
        ...
        this._manager.getUsers().subscribe(function (data) {
            //this.users = <any>data;
            _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](data["users"]);
            _this.dataSource.paginator = _this.paginator;
            _this.dataSource.sort = _this.sort1;
            _this.showloader = false;
        });
    ...
    UserManagerComponent.ctorParameters = function () { return [
...
var UserRolesComponent = /** @class */ (function () {
    function UserRolesComponent(_fb, _router, _avRouted, _manager) {
        ...
        this._manager.GetRoleAsignToUser(this.id).subscribe(function (res) {
            res["roles"].forEach(function (value, index) {
                _this.checkedArray = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormArray"]([]);
                _this.rlsFormArray.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]({
                    'id': value['id'],
                    'title': value['name'],
                    'selected': value['selected']
                }));
                if (value['selected'] == true) {
                    _this.checkedArray.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]({
                        'id': value['id'],
                        'title': value['name'],
                        'selected': value['selected']
                    }));
    ...
    UserRolesComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _Shared_services_manager_service__WEBPACK_IMPORTED_MODULE_3__["ManagerService"] }
