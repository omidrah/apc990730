...
var FetchDataComponent = /** @class */ (function () {
    function FetchDataComponent(santizer) {
    ...
    FetchDataComponent.prototype.uploadDone = function () {
        this.showloader = false;
    };
    FetchDataComponent.prototype.initLoader = function () {
...
var SplunkComponent = /** @class */ (function () {
    function SplunkComponent(santizer) {
        this.santizer = santizer;
        this.showloader = false;
    }
    SplunkComponent.prototype.ngOnInit = function () {
        // call this setTimer method when you want to set timer
        this.initLoader();
    };
    SplunkComponent.prototype.uploadDone = function () {
        this.showloader = false;
    };
    SplunkComponent.prototype.initLoader = function () {
        this.showloader = true;
    };
    SplunkComponent.ctorParameters = function () { return [
        { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["DomSanitizer"] }
    ]; };
...
//# sourceMappingURL=Splunks-splunk-module-es5.js.map