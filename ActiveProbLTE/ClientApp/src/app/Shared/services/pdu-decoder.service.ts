...
export class PduDecoderService {
  ...
  decode(pdu: string, ussd: boolean) {
  ...
  customTokenizer(octets) {
    ...
    var TP_UDHL: { [k: string]: any } = {};
    var TP_UDH: { [k: string]: any } = {};
    if (pduType.TP_UDHI) {
      pos++;
  ...
  tokens = {
    ...
    UDH: function (octets) {
      var i,
        ...
        IE: { [k: string]: any } = {},		// actual Information Element
        info = [],
        text = '',
        isWap = false,
        destPort,
